...
double* get_fluxes(double *Pstate_ptr, double* (*flux)(double*, double* (*)(double*, double int[DIM_NUM-1])));
double* rhlle(double *Pstate_ptr, double* (*riemann_input)(double*, double, int[DIM_NUM-1]));
